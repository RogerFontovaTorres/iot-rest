...
public class HomeMapperImpl implements HomeMapper {
    ...
    @Override
    public HomeDAO putHomeRequestToHomeDao(PutHomeRequest homeDao) {
        if ( homeDao == null ) {
            return null;
        }
        ...
        homeDAO.setName( homeDao.getName() );
        homeDAO.setAddress( homeDao.getAddress() );
        homeDAO.setDescription( homeDao.getDescription() );
